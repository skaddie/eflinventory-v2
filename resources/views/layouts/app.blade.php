            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><a class="has-arrow" href="/home" ><i class="mdi mdi-view-dashboard"></i>Dashboard</a></li>
                        ...
                        <div class="d-flex m-t-10 justify-content-end">
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                    ...
                                    <h4 class="m-t-0 text-info"><span style="text-decoration: ">₱</span><span class="lblMonthSales"></span></h4></div>
                            ...
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                    ...
                                    <h4 class="m-t-0 text-primary"><span style="text-decoration: ">₱</span><span class="lblLastMonthSales"></span></h4></div>
                                <div class="spark-chart">
