                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8"><span style="text-decoration: ">₱</span><span id="purchase-value-{{ $variation->id }}"></span></dd>
                                            <dt class="col-sm-4 text-right">Total Sales:</dt>
                                            <dd class="col-sm-8"><span style="text-decoration: ">₱</span><span id="sales-value-{{ $variation->id }}"></span></dd>
                                            <dt class="col-sm-4 text-right">Total Profit:</dt>
                                            <dd class="col-sm-8"><span style="text-decoration: ">₱</span><span id="profit-value-{{ $variation->id }}"></span></dd>
                                            <dt class="col-sm-4 text-right">Total Loss:</dt>
                                            <dd class="col-sm-8"><span style="text-decoration: ">₱</span><span id="loss-value-{{ $variation->id }}"></span></dd>
