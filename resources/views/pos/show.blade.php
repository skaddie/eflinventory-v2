                    ...
                    <div class="col-md-12 p-5">
                        ...
                        <div class="row">
                                ...
                                <div class="table-responsive m-t-40" style="clear:both">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">Unit Cost (<span class="">₱</span>)</th>
                                            <th class="text-right">Total (<span class="">₱</span>)</th>
                                        </tr>
                                        </thead>
                            ...
                            <div class="col-md-12">
                                <div class="pull-right text-right">
                                    <hr>
                                    <h3 class="pl-4 mb-2"><strong>Total:&nbsp;</strong><span class="  ">₱</span><span
                                                id="sell-total"></span></h3>
                                    <h6 class="pl-4"><strong>Amount Paid:&nbsp;</strong><span
                                                class="  ">₱</span><span id="amount-paid"></span></h6>
                                    <h6 class="pl-4"><strong>Remaining Balance:&nbsp;</strong><span
                                                class="  ">₱</span><span id="paid-balance"></span></h6>
                                    <h6 class="pl-4"><strong>Change:&nbsp;</strong><span class="  ">₱</span><span
                ...
                <div class="col-md-8 payment-input">
                    <div class="payment-input-scroll d-block">
                        <div class="cart-total py-3">
                            ...
                            <h1><span class="  ">₱</span><span class="payment-total"></span></h1>
                        </div>
                                                                ...
                                                                <div class='line'>
                                                                    <div class='entry total'>
                                                                        ...
                                                                        <span class='pr-1'><span
                                                                                    style="text-decoration:  ">₱</span></span><span
                                                                                class='value'>0.00</span>
                                                                        {{--<div class='sub-entry'>Taxes: <span style='text-decoration:  '>₱</span><span class='value'>0.00</span></div>--}}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                @foreach($products as $product)
                                                                    <div class="product" id="p-{{ $product->batch_id }}"
                                                                        ...
                                                                        <div class="product-img">
                                                                            ...
                                                                            <strong>
                                                                                <span style="text-decoration:  ">₱</span><span
  ...
  */
  ...
  function buildPOSProducts(variations, url) {
    $.each(variations, function (k, v) {
      ...
      html += "<span class=\"price-tag\"><strong><span style=\"text-decoration:  \">₱</span>" +
        ...
        $.each(response, function (k, v) {
          for (var key in v) {
            ...
            cart_item += "<li class='order-line'><span class='product-name'>" +
              v[key].name + "</span><span class='price'><span style='text-decoration:  '>₱</span><span class='price-value'>"
              ...
              + "<span style='text-decoration:  '>₱</span><span class='price-value'>" + v[key].price + "</span>"
              + "</li></ul></li></ul>";
      ...
      /*$.each(response, function(k, v) {
          for (var key in v) {
              ...
              cart_item += "<li class='order-line selected'><span class='product-name'>" +
                      name + "</span><span class='price'><span style='text-decoration:  '>₱</span><span class='price-value'>"
  ...
  function appendToCart(id, name, price, quantity) {
    ...
    cart_item += "<li class='order-line selected'><span class='product-name'>" +
      ...
      + "<span style='text-decoration:  '>₱</span><span class='price-value'>" + price + "</span>"
      + "</li></ul></li></ul>";
