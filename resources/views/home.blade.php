                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row">
                        <div class="align-self-center">
                            <span class="display-6 text-white"><span class="">₱</span>{{ number_format($today_sales, 2) }}</span>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card card-inverse card-success animated fadeInDown">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row">
                        <div class="align-self-center">
                            <span class="display-6 text-white"><span class="">₱</span>{{ number_format($today_profit, 2) }}</span>
                            <h6 style="color: rgba(255,255,255,.8) !important; font-size:11px;">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card card-inverse card-danger animated fadeInDown">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row">
                        <div class="align-self-center">
                            <span class="display-6 text-white"><span style="text-decoration: ">₱</span>{{ number_format($inventory_summary, 2) }}</span>
